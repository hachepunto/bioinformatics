...
```
sshfs alumnoX@10.0.13.97:/home/alumnoX/ ~/mnt/drona -o local -o volname="drona" -o noappledouble -o defer_permissions 
```
...
```
sshfs alumnoX@10.0.13.97:/home/alumnoX/ ~/mnt/drona 
```
...
```\\sshfs\alumnoX@10.0.13.97:/home/alumnoX/```
o
