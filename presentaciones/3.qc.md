...
# Creamos un directorio para nuestros datos
mkdir RNA_seq
cd RNA_seq

# Descargamos los datos para el curso
wget http://genomedata.org/rnaseq-tutorial/HBR_UHR_ERCC_ds_5pc.tar

# Los descomprimimos
tar xvf HBR_UHR_ERCC_ds_5pc.tar

# Inspeccionamos las primeras líneas de uno de los archivos
zcat HBR_Rep1_ERCC-Mix2_Build37-ErccTranscripts-chr22.read1.fastq.gz | head
```

Ahora si probemos kallisto en una muestra (el índice para el chr22 ya está en drona).
