...
Copia todo el texto de abajo y guárdalo en un archivo fastp.sh dentro en tu home, esto lo puedes hacer con el bloc de notas, NotePad, gedit, TextEdit, nano, o cualquier otro editor de texto plano.
