...
```
Esto nos creo 3 carpetas con la cuanticación de las muestras que empiezan con HBR, ahora intenta haces un archivo uhr_kallisto.sh que haga lo mismo en las muestras que empiezan con UHR.
